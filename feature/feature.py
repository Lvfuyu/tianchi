...
def calculate(pdata, psample, pres):
	...
	for data_line in data_lines:
		...
		data_list = [class_id, brand_id, compartment, type_id, level_id, department_id, TR, gearbox_type, displacement, if_charging, price_level, driven_type_id, fuel_type_id, newenergy_type_id, emission_standards_id, if_MPV_id, if_luxurious_id, sale_quantity]
